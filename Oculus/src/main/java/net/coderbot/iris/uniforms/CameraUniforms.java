...
import net.coderbot.iris.compat.CameraHelper;
...
public class CameraUniforms {
    ...
    private static int getRenderDistanceInBlocks() {
        // In 1.12.2, use gameSettings.renderDistanceChunks
        return client.gameSettings.renderDistanceChunks * 16;
    }

    public static Vector3d getUnshiftedCameraPosition() {
        // In 1.12.2, use our CameraHelper to get camera position
        return CameraHelper.getCameraPosition();
    }
