...
public class FinalPassRenderer {
    ...
    public FinalPassRenderer(ProgramSet pack, RenderTargets renderTargets, IntSupplier noiseTexture,
        ...
        this.lastColorTextureId = MainRenderTarget.getColorTextureId();
        this.lastColorTextureVersion = MainRenderTarget.getColorBufferVersion();
    ...
    public void renderFinalPass() {
        ...
        final int baseWidth = MainRenderTarget.getWidth();
        final int baseHeight = MainRenderTarget.getHeight();
        ...
        int currentColorVersion = MainRenderTarget.getColorBufferVersion();
        int currentColorTexture = MainRenderTarget.getColorTextureId();
        if (currentColorVersion != lastColorTextureVersion || currentColorTexture != lastColorTextureId) {
            lastColorTextureVersion = currentColorVersion;
            this.lastColorTextureId = currentColorTexture;
        ...
        if (this.finalPass != null) {
            ...
            colorHolder.bind();
            GlStateManager.viewport(0, 0, baseWidth, baseHeight);
            ...
            IrisRenderSystem.copyTexSubImage2D(MainRenderTarget.getColorTextureId(), GL11.GL_TEXTURE_2D, 0, 0, 0, 0, 0, baseWidth, baseHeight);
        }
