...
public class CenterDepthSampler {
    ...
    public CenterDepthSampler(IntSupplier depthSupplier, float halfLife) {
        ...
        InternalTextureFormat format = caps.OpenGL32 ? InternalTextureFormat.R32F : InternalTextureFormat.RGB16;
    ...
    public void sampleCenterDepth() {
        ...
        // Reset viewport to main framebuffer - in 1.12.2 we bind to default framebuffer
