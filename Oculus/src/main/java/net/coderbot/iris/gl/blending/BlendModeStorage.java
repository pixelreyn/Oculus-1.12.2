...
public class BlendModeStorage {
    ...
    public static void overrideBlend(BlendMode override) {
        if (!blendLocked) {
            ...
            GlStateManager.BlendState blendState = GlStateManagerHelper.getBlendState();

            originalBlendEnable = GlStateManagerHelper.isBooleanStateEnabled(blendState.blend);
