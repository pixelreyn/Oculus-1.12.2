...
public class IrisSamplers {
    ...
    // In 1.12.2, lightmap is on GL unit 1. But Iris's sampler system treats unit 1 as
    // overlay and unit 2 as lightmap (matching 1.16+ conventions). The shader patching
    // handles the coordinate transform; the actual GL binding is what matters.
