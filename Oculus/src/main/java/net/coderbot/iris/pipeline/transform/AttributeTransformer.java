...
class AttributeTransformer {
    ...
    public static void transform(
        ...
        // In 1.16+, gl_MultiTexCoord1 is remapped to gl_MultiTexCoord2 because
        // the overlay texture is on unit 1 and lightmap on unit 2.
        // In 1.12.2, there is no overlay and lightmap is on unit 1, so we
        // keep gl_MultiTexCoord1 as-is.
