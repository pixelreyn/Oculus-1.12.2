...
public class RenderTarget {
    ...
    public RenderTarget(Builder builder) {
        ...
        // In 1.12.2, GlStateManager doesn't have batch texture generation, use individual calls
        this.mainTexture = GlStateManager.generateTexture();
        this.altTexture = GlStateManager.generateTexture();
    ...
    public void destroy() {
        ...
        // In 1.12.2, GlStateManager doesn't have batch texture deletion
