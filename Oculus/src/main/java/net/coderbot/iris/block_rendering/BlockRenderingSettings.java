...
public class BlockRenderingSettings {
    ...
    private Map<IRegistryDelegate<Block>, BlockRenderType> blockTypeIds;
    ...
    @Nullable
    public Map<IRegistryDelegate<Block>, BlockRenderType> getBlockTypeIds() {
        return blockTypeIds;
    }

    public void setBlockTypeIds(Map<IRegistryDelegate<Block>, BlockRenderType> blockTypeIds) {
